...
const TotalSalesOverTimeColumnChart = () => {
  ...
  const chartOptions = {
    ...
    series: [
      {
        ...
        data: seriesData,
        color: '#FFB996',
        type: 'column', // Set type to column
      }
    ],
    tooltip: {
      formatter: function () {
    ...
    plotOptions: {
      column: {
        borderRadius: 10, // Add borderRadius to round corners
        dataLabels: {
          enabled: true,
          formatter: function() {
...
export default TotalSalesOverTimeColumnChart;
